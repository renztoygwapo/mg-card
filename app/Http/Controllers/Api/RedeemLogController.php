...
class RedeemLogController extends Controller
{
    /**
    ...
    {
        $items = RedeemLog::latest();

        if ($request->month != 'null') {
            $items = $items->whereMonth('created_at','=', $request->month)
    ...
    public function convertToExcel($sheetData)
    {
        ...
        Excel::create('REDEEM LOGS', function($excel) use ($sheetData) {
    
            // Set the spreadsheet title, creator, and description
            $excel->setTitle('REDEEM LOGS');
            $excel->setDescription('REDEEM LOGS');
